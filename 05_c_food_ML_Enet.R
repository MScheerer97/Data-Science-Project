...
# In this file: 0 < mixture() < 1; otherwise LASSO or elastic net is selected
# To tune the lambda/penalty and mixture/alpha parameters a random grid of
# 2.500 values is selected. 
...
saveRDS(ENET_best_param_final, "models/ENET/perf_results/ENET_perf_food_model.rds")
saveRDS(ENET_pred_final, "models/ENET/perf_results/ENET_pred_food_model.rds")
